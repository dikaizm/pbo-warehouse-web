...
const UserListPage: FC = function () {
  return (
    <NavbarSidebarLayout isFooter={false}>
      ...
      <Pagination page={0} limit={0} totalData={0} totalPage={0} hasNext={false} hasPrev={false} onPageChange={function (page: number): void {
...
export const Pagination: FC<PaginationProps> = function ({ page, limit, totalData, totalPage, hasNext, hasPrev, onPageChange }) {
  return (
